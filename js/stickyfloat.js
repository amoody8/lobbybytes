/*
   ...
   $Version: 24.12.2012 r6 (made sure the scroll event filed AFTER window was loaded, and floated the element on refresh with '0' duration)
	...
	$.fn.stickyfloat = function(options){
		...
		function initFloat(o, duration){
			...
			if( (pastStartOffset || objFartherThanTopPos) && objBiggerThanWindow ){ 
				...
				if( duration > 5 )
					$obj.stop().delay(opts.delay).animate({ top: newpos }, duration , opts.easing );
				else
