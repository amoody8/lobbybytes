...
//Register Sidebars
	register_sidebar(array(
  		'name' => __( 'Map' ),
  		'id' => 'map',
  		'description' => __( 'This widget should only contain the google map shortcode' ),
	));
...
//function am_styles() {wp_enqueue_style( 'lobbybytes-ui', get_template_directory_uri().'/css/lobbybytes-theme/jquery-ui-1.10.4.custom.min.css' );}
//add_action( 'wp_enqueue_scripts', 'am_styles' ); 
...
class about_widget extends WP_Widget {
    ...
    function about_widget() {
        parent::WP_Widget(false, $name = 'About Us Widget');	
    }
