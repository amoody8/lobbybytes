...
class AM_Upcoming_Events_Widget extends WP_Widget {
    ...
    */
    ...
    public function form( $instance ) {
        ...
        $default_template = "<section class='widget event'><ul><li><time datetime='2014-02-26'>[start-date format='D']<strong>[start-date format='d']</strong>[start-date format='M']<span>[start-date format='Y']</span></time>
        <ul class='events'>
        						<li>
        ...
        $defaults = array( 
            ...
            'after' => '<a href="/taogroup/saharadreamswebsite/beta/events" rel="bookmark" class="btn">' . __('See All Events', 'am-events') . '</a>', 
            'before' => '',  
            );
